...
const data =[{"d":"12589635785621","y":"2016/11/06 12:20:30","s":"四哈","w":"89562748633"},]
export default class Shouhou extends React.Component{
	render(){
		...
		<button id={data.id} className="lqbdd_4" >拒绝退货/款</button>
		<button className="lqbdd_5">同意退货/款</button>
		</div>
		</div>			
		</div>
			    })
